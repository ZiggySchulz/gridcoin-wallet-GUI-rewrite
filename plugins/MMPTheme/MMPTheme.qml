...
QtObject {
    ...
    readonly property color seperatorColor: isLightTheme ? cLilyWhite : translucent(cLightSlateGray, 0.4)
    ...
    readonly property color bodySeperatorColor: isLightTheme ? cLilyWhite : cBlack
    //Theme enumeration
